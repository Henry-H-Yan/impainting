function crack_map = batchFiltering_inv(path_data, name, filterset, filter_params, general_settings)
...
for i = 1:length(fileset)  
    ...
    im = im2double(im);
    im_filtered = useElongatedFilters_inv(im, filterset, filter_params);
